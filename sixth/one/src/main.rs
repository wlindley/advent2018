...
impl Rect {
    ...
    fn enclosing(points: &Vec<Point>) -> Rect {
        return points
            .iter()
            .fold(Rect::new(std::i32::MAX, std::i32::MAX, std::i32::MIN, std::i32::MIN),
                  |rect, p| {
...
mod tests {
    ...
    fn test_rect_enclosing() {
        assert_eq!(Rect::new(0, 0, 0, 0), Rect::enclosing(&vec![Point::new(0, 0)]));
        assert_eq!(Rect::new(0, 0, 2, 2), Rect::enclosing(&vec![Point::new(0, 0), Point::new(2, 2)]));
        assert_eq!(Rect::new(1, 2, 3, 4), Rect::enclosing(&vec![Point::new(3, 4), Point::new(1, 2)]));
        assert_eq!(Rect::new(1, 2, 3, 4), Rect::enclosing(&vec![Point::new(3, 2), Point::new(1, 4)]));
    }
}
